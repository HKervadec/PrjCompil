...
/**************************************/
  ...
  static final public void valConst() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
         tabIdent.setTmpValue(false, Ident.ENTIER, YakaTokenManager.entierLu);
      break;
    case ident:
      jj_consume_token(ident);
    ...
    case VRAI:
      jj_consume_token(VRAI);
         tabIdent.setTmpValue(false, Ident.BOOLEAN, -1);
      break;
    case FAUX:
      jj_consume_token(FAUX);
         tabIdent.setTmpValue(false, Ident.BOOLEAN, 0);
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void type() throws ParseException {
    ...
    case ENTIER:
      jj_consume_token(ENTIER);
         tabIdent.lastType = Ident.ENTIER;
      break;
    case BOOLEEN:
      jj_consume_token(BOOLEEN);
         tabIdent.lastType = Ident.BOOLEAN;
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
